...
@php
    // Lucide-style stroke icons. Each entry is the inner markup of the SVG.
    $icons = [
        ...
        'agent' => '<circle cx="12" cy="8" r="4"/><path d="M6 21v-1a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v1"/><path d="m9 8 1.5 1.5L14 6"/>',
        ...
        'signature' => '<path d="M3 17c3.5 0 3.5-9 7-9s3.5 9 7 9 3.5-4 3.5-4"/><path d="M2 21h20"/>',
        'presentation' => '<path d="M2 3h20"/><path d="M3 3v11a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V3"/><path d="m8 21 4-4 4 4"/><path d="M12 17v-4"/>',
        ...
        'chart' => '<line x1="3" y1="21" x2="21" y2="21"/><rect x="5" y="11" width="3" height="7"/><rect x="10.5" y="7" width="3" height="11"/><rect x="16" y="13" width="3" height="5"/>',
        ...
        'quote' => '<path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2-2-2H4c-1.25 0-2 .75-2 2v6c0 1.25.75 2 2 2h2c0 4-1 6-3 6z"/><path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2-2-2h-4c-1.25 0-2 .75-2 2v6c0 1.25.75 2 2 2h2c0 4-1 6-3 6z"/>',
        ...
        'rand' => '<path d="M12 2v20M2 12h20"/>',
        'x-alt' => '<line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/>',
    ];
    $inner = $icons[$name] ?? '';
@endphp
